...
Milk products dominate the bottom of the animal products, along with baby chickens and pig offal. The bottom 5 plant products are all less than the lowest animal product. One of the main reasons for this is many animals are fed plant products, which gets counted into their water footprint. There are actually 22 plant products that have smaller total water footprints than the smallest animal water footprint. What surprised me is the majority of water sources on this list is atrributed to green sources. 

Next lets look at the top 6 animal products as found in the dataset. I had to pick the top 6 becuase of a tie. Also, I did think about editing this list of outliers, but I wanted to stay true to the source data. 
...
I think my desire to remove an outlier makes more sense now, and I am not just talking about the visual aspect. Once again, I highly recommend hovering over the graph and clicking the "Compare data on hover" button to make the data more visible. This list is dominated by mainly horse products and 1 non-food cow product. In the US, horses are not typically consumed and were actually illegal from 2006-2011, so from an environmental perspective most people aren't consuming the most water intensive meats. 
...
Once again, the full dataset is at the bottom of this post if you want to see all 106 animal products. Lets start with the different whole, animals. 
...
I found it really interesting that generally speaking, the more lean the meat the smaller the water footprint. It would be interesting to see if that holds up when nutrition and macros are factored in. I was also once again surprised that the vast majority of the water souce is green. If you take out the green (by clicking the legend), the trend totally changes. The bottom three products (turkey, chicken/duck/goose, and pigs) by total actually use the most grey and blue water souces. This really shows that there is far more nuance in how environmentally friendly certain products are, and this is just taking water into account. 

The follow graph looks a little deeper into beef. 
...
Moving on, lets take a look at some other common animal products, including one of my favorites Cheese! A quick note, I did lump the following cheese categories into "Processed Cheese" because they use the same amount of water:
...
Most of the products are milk or made from milk. I didn't realize whole milk requires slightly more water than skim. It also made sense that yogurt required much less water than fresh cheese, and processed cheese require more water than fresh. I didn't expect eggs to be so high on this list, but they required much more water than milk. Finally, butter required the most water of any milk product. I added the final product because "cured swine bellies" is really round about way of saying Bacon! I mostly just added that becuase its also one of my favorite foods. Bacon does require more water than regular pork to produce. 
...
I am not a huge leather person, but I thought this was worth sharing. I don't imagine there is much overlap between people who wear leather and people who care about water footprints, but if you are one of those people you are in luck today! I would recommend getting sheep, lamb, or goat leather over cow leather as there is a huge difference in water usage. 

#All Numbers

Thank you for reading down this far! This post ended up being longer than expected. As promised above, here are the explorable, full datasets. The data is sortable by column (just click on the column name), or you can just type words into the search bar to find specific products. 
