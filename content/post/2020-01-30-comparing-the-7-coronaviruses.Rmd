...
The other three (MERS-CoV, SARS-CoV, and 2019-nCoV) are much more unique. They represent examples of new viruses that emerge after "jumping" from animals to humans. These viruses are known to infect animals, but a random mutation allows them to suddenly start infecting humans. An outbreak occurs when those people are then able to infect other people. 
