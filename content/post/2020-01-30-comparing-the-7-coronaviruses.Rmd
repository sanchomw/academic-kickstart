...
The first four (229E, NL63, OC43, and HKU1) are often associated with the common cold [CDC (2020)](https://www.cdc.gov/coronavirus/types.html), but can lead to more severe complications. Much like the cold, infections are much more common during the winter months and cases drop to almost none during the summer [Gaunt, Hardie, Claas, Simmonds, & Templeton, 2010](https://jcm.asm.org/content/jcm/48/8/2940.full.pdf). [Guant et. al](https://jcm.asm.org/content/jcm/48/8/2940.full.pdf) tested 11,661 sick people between 2006 and 2009 and found 267 (2.3%) tested positive for at least one of the four corona viruses.
